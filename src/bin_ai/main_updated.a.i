// Updated main.a.i file that uses string dictionary for all strings
// Load the string dictionary
🔠("string_dictionary.json");

// Import core modules
ι agent_module = ⟰(:core_agent_module);
ι config_module = ⟰(:core_config_module);
ι error_module = ⟰(:core_error_module);

// Import other modules
ι planner_module = ⟰(:planner_module);
ι executor_module = ⟰(:executor_module);
ι memory_module = ⟰(:memory_module);
ι browser_module = ⟰(:browser_module);
ι file_module = ⟰(:file_module);
ι shell_module = ⟰(:shell_module);
